        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(Upload.this,"Type is "+type,Toast.LENGTH_LONG).show();
                if(file_path!=null && !type.equals("")){
                    UploadFile();
                }
                else{
                    Toast.makeText(Upload.this, "Please Select File and Type First ", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        });
    ...
    private void filePicker(){
        ...
        Toast.makeText(Upload.this, "File Picker Call", Toast.LENGTH_SHORT).show();
        //Let's Pick File
    ...
    private BroadcastReceiver onDownloadComplete=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(downloadId==id){
                Toast.makeText(Upload.this, "Download Completed", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void requestPermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(Upload.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            Toast.makeText(Upload.this, "Please Give Permission to Upload File", Toast.LENGTH_SHORT).show();
        }
        else{
            ActivityCompat.requestPermissions(Upload.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},PERMISSION_REQUEST_CODE);
        }
    }

    private boolean checkPermission(){
        int result= ContextCompat.checkSelfPermission(Upload.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        ...
        switch (requestCode){
            case PERMISSION_REQUEST_CODE:
                if(grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(Upload.this, "Permission Successfull", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    public class UploadTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
           ...
           // progressBar.setVisibility(View.GONE);
            if(s.equalsIgnoreCase("true")){
                ...
                Toast.makeText(Upload.this, "Failed Upload", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected String doInBackground(String... strings) {
            if(uploadFile(strings[0],email,type)){
                return "true";
            }
            else{
                return "failed";
        ...
        private boolean uploadFile(String path,String email,String type){
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                       runOnUiThread(new Runnable() {
                          ...
                          Log.d("SUCCESS UKUDOX",response.message());
                    }
                });
                return true;
            }

...
public class AccountCreation extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // String Un =gl.checkUsernameFromServer(uname);
                String pin = password.getText().toString();

           sendAdminToServer(uname,pin);
    ...
    public void sendAdminToServer(String username,String  password){
        String url= AppConstants.BASE_URL+"accountCreation.php";
        RequestQueue requestQueue= Volley.newRequestQueue(getApplicationContext());
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if(response.equalsIgnoreCase("Successfully")){
                    Toast.makeText(AccountCreation.this, "Successfully ", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(AccountCreation.this, MainActivity2.class);
